...
var 
	...
	//	posX = undefined,
	//	posY = undefined,
	aCanvas = new Array(),					// aCanvas a utilizar para las imagenes a imprimir
	ctx,
	aSuma, aVert;
...
//	}
	...
	function dibujaPag() {
		...
		document.body.appendChild(aCanvas[aCanvas.length-1]);
		ctx = aCanvas[aCanvas.length-1].getContext("2d");

		aCanvas[aCanvas.length-1].width = anchoCanvas;
		aCanvas[aCanvas.length-1].height = altoCanvas;

		//<aCanvas id="aCanvas1" width="560" height="794" class="img-responsive" style="border:1px solid #000000;"></aCanvas>
